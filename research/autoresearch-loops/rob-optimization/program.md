# ROB Optimization Loop (Friday Night Protocol)

## Goal
Optimize ROB's core files (`MEMORY.md`, `HEARTBEAT.md`, `SOUL.md`, and custom instructions) to achieve a perfect 100% success rate on the standard benchmark suite.
...
1. **Hypothesis:** Mutate the formatting, structure, or content of ROB's `MEMORY.md` (e.g., changing from raw markdown to structured JSON-like blocks) or `HEARTBEAT.md` to improve performance on a specific benchmark test.
